...
function welcome4(){
	...
	document.getElementById("action_button").innerHTML="<button id='v1' onclick='welcome5()'>Huh?  Tell me more...again! again.</button>"
}

function welcome5(){
	document.getElementById("msg6").innerHTML="If your opponent is at or below 0 health, the finisher is nearly sure to provide you with the win..."
...
function welcome6(){
	...
	document.getElementById("action_button").innerHTML="<button id='v1' onclick='welcome7()'>Makes sense!</button>"
}
...
function welcome8(){
	...
	document.getElementById("action_button").innerHTML="<button onclick='location.href=\"http://localhost:8000/Desktop/strident-kumquat/bodyslam_game/game.html\"'>Got it.  Let's go!</button>"
}